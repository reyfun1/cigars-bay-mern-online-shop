            ...
            <div className="card p-5"> <span className="circle"><i className="fa fa-check" /></span>
              <div>
                  ...
                  <div className="form-input my-3"> <i className="fa fa-envelope" /> 
                    <input disabled={loading ? true : false} type="text" className="form-control" placeholder="Name" value={name} onChange={e => setName(e.target.value)} /> </div>
                  <div className="form-input mb-3"> <i className="fa fa-envelope" /> 
                    <input disabled={loading ? true : false} type="email" className="form-control" placeholder="Email address" value={email} onChange={e => setEmail(e.target.value)} /> </div>
                  <div className="form-input mb-3"> <i className="fa fa-lock" />
                    <input disabled={loading ? true : false} type="password" className="form-control" placeholder="Password" value={pass1} onChange={e => setPass1(e.target.value)} /> </div>
                  <div className="form-input"> <i className="fa fa-lock" /> 
                    <input disabled={loading ? true : false} type="password" className="form-control" placeholder="Password (Repeat)"  value={pass2} onChange={e => setPass2(e.target.value)} /> </div>
                    {loading ? (
